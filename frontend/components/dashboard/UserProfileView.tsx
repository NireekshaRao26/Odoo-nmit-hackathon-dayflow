...
export default function UserProfileView({
    ...
    return (
      <div className="flex h-96 items-center justify-center bg-zinc-950 text-zinc-400">
        <div className="flex flex-col items-center space-y-3">
          <svg className="animate-spin h-7 w-7 text-purple-500" fill="none" viewBox="0 0 24 24">
  ...
  if (!profile) {
    return (
      <div className="text-center py-12 text-zinc-500">
        ...
        <button onClick={onClose} className="mt-4 text-xs text-purple-400 underline">
          Return to Employees
        </button>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      {/* Toast Alert */}
      {toastMsg && (
        <div className="fixed bottom-6 right-6 z-50 rounded-md bg-purple-600 px-4 py-2.5 text-xs font-semibold text-white shadow-2xl transition animate-bounce">
          {toastMsg}
        </div>
      )}

      {/* Profile Header Details card */}
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6 flex flex-col md:flex-row md:items-start md:space-x-6 gap-4 relative">
        <button
          onClick={onClose}
          className="absolute right-4 top-4 text-xs text-zinc-500 hover:text-zinc-300 flex items-center space-x-1 cursor-pointer"
        >
          <span>✕ Close</span>
        </button>
        ...
        <div className="flex-shrink-0 mx-auto md:mx-0">
          {profile.avatar_url ? (
            ...
            <div className="h-24 w-24 rounded-xl bg-purple-950/40 border border-purple-500/25 flex items-center justify-center font-bold text-purple-300 text-3xl">
              {avatarLetters}
            </div>
          )}
        </div>
        ...
        <div className="flex-1 space-y-4">
          <div>
            ...
            <p className="text-sm text-zinc-400 text-center md:text-left mt-0.5">
              {profile.position} • {profile.department}
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-3 gap-x-6 text-xs text-zinc-400 border-t border-zinc-850 pt-4">
            <div>
              <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Login ID</span>
              <strong className="text-zinc-200 mt-0.5 block font-mono">{profile.employee_id}</strong>
            </div>
            <div>
              <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Email</span>
              <span className="text-zinc-200 mt-0.5 block truncate">{profile.email}</span>
            </div>
            <div>
              <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Phone</span>
              <span className="text-zinc-200 mt-0.5 block">{profile.phone || "Not Specified"}</span>
            </div>
            <div>
              <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Company</span>
              <span className="text-zinc-200 mt-0.5 block">{profile.company_name}</span>
            </div>
            <div>
              <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Manager</span>
              {isEditingHeader ? (
                <input
                  type="text"
                  ...
                  className="bg-zinc-950 border border-zinc-800 text-white rounded px-2 py-0.5 text-xs w-full mt-1 focus:outline-none focus:border-purple-600"
                />
              ) : (
                <span className="text-zinc-200 mt-0.5 block">{profile.manager || "Not Assigned"}</span>
              )}
            </div>
            <div>
              ...
              {isEditingHeader ? (
                ...
                <span className="text-zinc-200 mt-0.5 block">{profile.location || "Not Specified"}</span>
              )}
            </div>
          </div>
              ...
              {isEditingHeader ? (
                <div className="flex space-x-2">
                  <button
                    ...
                    className="bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 rounded text-xs font-semibold cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-3 py-1 rounded text-xs cursor-pointer"
                  >
                    Cancel
                  </button>
                </div>
      ...
      {/* Tabs list */}
      <div className="flex items-center space-x-2 border-b border-zinc-800 pb-px">
        <button
      ...
      <div className="min-h-96">
        ...
        {activeTab === "resume" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                <div className="flex items-center justify-between border-b border-zinc-850 pb-3">
                  <h3 className="text-sm font-bold text-white uppercase tracking-wider">Professional Bio</h3>
                ...
                <div className="space-y-4 text-xs">
                  <div>
                    <h4 className="font-semibold text-zinc-400 uppercase tracking-wide text-[10px]">About Me</h4>
                    {isEditingResume ? (
                      <textarea
                        value={editProfileForm.about || ""}
                        onChange={(e) => setEditProfileForm({ ...editProfileForm, about: e.target.value })}
                        placeholder="Share a short bio..."
                        className="bg-zinc-950 border border-zinc-800 text-white rounded p-2 text-xs w-full mt-2 focus:outline-none focus:border-purple-600 h-20 resize-none"
                      />
                    ) : (
                      <p className="text-zinc-200 leading-relaxed mt-1.5 whitespace-pre-line">
                  ...
                  <div>
                    <h4 className="font-semibold text-zinc-400 uppercase tracking-wide text-[10px] mt-4">What I Love About My Job</h4>
                    {isEditingResume ? (
                      <textarea
                  ...
                  <div>
                    <h4 className="font-semibold text-zinc-400 uppercase tracking-wide text-[10px] mt-4">Interests & Hobbies</h4>
                    {isEditingResume ? (
                      <textarea
                  ...
                  {isEditingResume && (
                    <div className="pt-2 flex space-x-2">
                      <button
                        ...
                        disabled={saveLoading}
                        className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-1.5 rounded text-xs font-semibold cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-4 py-1.5 rounded text-xs cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
            ...
            <div className="space-y-6">
              ...
              {/* Skills section */}
              <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                <h3 className="text-sm font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-3">Skills</h3>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {(editProfileForm.skills || []).length > 0 ? (
                    (editProfileForm.skills || []).map((skill, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center rounded bg-purple-950/30 px-2 py-0.5 text-xs font-semibold text-purple-400 border border-purple-500/10"
                      >
                        {skill}
                        {isEditingResume && (
                          <button
                            ...
                            className="ml-1 text-purple-500 hover:text-rose-400 font-bold focus:outline-none"
                          >
                            ✕
                          </button>
                        )}
                    ...
                    <span className="text-xs text-zinc-500">No skills listed yet.</span>
                  )}
                </div>

                {isEditingResume && (
                  <div className="flex items-center space-x-2 pt-2 border-t border-zinc-850">
                    <input
                      type="text"
                      value={newSkill}
                      onChange={(e) => setNewSkill(e.target.value)}
                      placeholder="Add skill (e.g. React)"
                      className="bg-zinc-950 border border-zinc-800 text-white rounded px-2.5 py-1 text-xs w-full focus:outline-none focus:border-purple-600"
                    />
                    <button
                      type="button"
                      onClick={handleAddSkill}
                      className="bg-zinc-800 hover:bg-zinc-700 text-white px-3 py-1 rounded text-xs cursor-pointer font-bold"
                    >
                      +
                    </button>
                  </div>
              ...
              <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                <h3 className="text-sm font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-3">Certifications</h3>
                ...
                <div className="space-y-2.5">
                  {(editProfileForm.certifications || []).length > 0 ? (
                    (editProfileForm.certifications || []).map((cert, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between text-xs text-zinc-200 bg-zinc-950/40 p-2.5 border border-zinc-850 rounded"
                      >
                    ...
                    <span className="text-xs text-zinc-500 block">No certifications listed yet.</span>
                  )}
                </div>
        ...
        {activeTab === "private" && (
          <div className="space-y-6">
                ...
                {isEditingPrivate ? (
                  <div className="flex space-x-2">
                    <button
                      ...
                      disabled={saveLoading}
                      className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-1.5 rounded text-xs font-semibold cursor-pointer shadow-md"
                    >
                  ...
                  <button
                    ...
                    className="bg-zinc-900 border border-zinc-800 hover:bg-zinc-850 text-zinc-300 font-semibold px-4 py-2 text-xs rounded-lg cursor-pointer transition shadow-md"
                  >
            ...
            {!privateInfo && !isEditingPrivate ? (
              <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-8 text-center text-zinc-500 text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                  <h3 className="text-sm font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-3">Personal Details</h3>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Date of Birth</span>
                      {isEditingPrivate ? (
                        <input
                          type="date"
                          value={editPrivateForm.dob || ""}
                          onChange={(e) => setEditPrivateForm({ ...editPrivateForm, dob: e.target.value })}
                          className="bg-zinc-950 border border-zinc-800 text-white rounded px-2.5 py-1 text-xs w-full mt-1.5 focus:outline-none focus:border-purple-600"
                        />
                      ) : (
                        <span className="text-zinc-200 mt-1 block font-medium">{privateInfo?.dob || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Nationality</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium">{privateInfo?.nationality || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-sans font-semibold">Gender</span>
                      {isEditingPrivate ? (
                        <select
                          value={editPrivateForm.gender || ""}
                          onChange={(e) => setEditPrivateForm({ ...editPrivateForm, gender: e.target.value })}
                          className="bg-zinc-950 border border-zinc-800 text-white rounded px-2 py-1 text-xs w-full mt-1.5 focus:outline-none focus:border-purple-600"
                        >
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium">{privateInfo?.gender || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Marital Status</span>
                      {isEditingPrivate ? (
                        <select
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium">{privateInfo?.marital_status || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Date of Joining</span>
                      {isEditingPrivate ? (
                        <input
                          type="date"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium">{privateInfo?.joining_date || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-semibold">Personal Email</span>
                      {isEditingPrivate ? (
                        <input
                          type="email"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium truncate">{privateInfo?.personal_email || "Not configured"}</span>
                      )}
                    </div>

                    <div className="sm:col-span-2">
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Residential Address</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium leading-relaxed">{privateInfo?.address || "Not configured"}</span>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                  <h3 className="text-sm font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-3">Banking & Statutory Code</h3>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-semibold">Bank Name</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium">{privateInfo?.bank_name || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-mono font-semibold">Account Number</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium font-mono">{privateInfo?.bank_account || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-mono font-semibold">IFSC Code</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium font-mono">{privateInfo?.ifsc_code || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-mono font-semibold">PAN Number</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium font-mono">{privateInfo?.pan_number || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-mono font-semibold">UAN Number</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium font-mono">{privateInfo?.uan_number || "Not configured"}</span>
                      )}
                    </div>

                    <div>
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-mono font-semibold">Employee Code</span>
                      {isEditingPrivate ? (
                        <input
                          type="text"
                        ...
                        <span className="text-zinc-200 mt-1 block font-medium font-mono">{privateInfo?.employee_code || "Not configured"}</span>
                      )}
                    </div>
                  </div>
                </div>
        ...
        {activeTab === "salary" && isHr && (
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center pb-3 border-b border-zinc-800">
              <div>
                <h3 className="text-sm font-bold text-white uppercase tracking-wider">Payroll & Wage Configurations</h3>
                <p className="text-[11px] text-zinc-400 mt-0.5">Define wage types, working schedule, professional tax, and PF rates.</p>
              </div>
            ...
            {!salaryInfo && !isEditingSalary ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                    <h4 className="text-xs font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-2.5">Wage & Schedule</h4>
                    
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Wage Type</span>
                        {isEditingSalary ? (
                          <input
                            type="text"
                          ...
                          <span className="text-zinc-200 mt-1 block font-medium">{salaryInfo?.wage_type}</span>
                        )}
                      </div>

                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-semibold">Monthly Wage</span>
                        {isEditingSalary ? (
                          <input
                            type="number"
                          ...
                          <span className="text-zinc-200 mt-1 block font-semibold text-purple-400">
                      ...
                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Yearly Wage (Calculated)</span>
                        <span className="text-zinc-400 mt-2 block font-medium">
                          ₹{Number((isEditingSalary ? editSalaryForm.monthly_wage || 0 : salaryInfo?.monthly_wage || 0) * 12).toLocaleString()} / year
                        </span>
                      </div>

                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-semibold">Working Days / Week</span>
                        {isEditingSalary ? (
                          <input
                            type="number"
                          ...
                          <span className="text-zinc-200 mt-1 block font-medium">{salaryInfo?.working_days_per_week} days</span>
                        )}
                      </div>

                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-semibold">Daily Break Time</span>
                        {isEditingSalary ? (
                          <input
                            type="number"
                            step="0.5"
                          ...
                          <span className="text-zinc-200 mt-1 block font-medium">{salaryInfo?.break_hours} hours</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                    <div className="flex items-center justify-between border-b border-zinc-850 pb-2.5">
                      <h4 className="text-xs font-bold text-white uppercase tracking-wider">Salary Components Breakup</h4>
                      {calcs && (
                        <span className="text-[11px] font-semibold text-zinc-400">
                          Sum: <strong className="text-purple-400">₹{calcs.totalCalculated.toLocaleString()}</strong> / ₹{Number(isEditingSalary ? editSalaryForm.monthly_wage || 0 : salaryInfo?.monthly_wage || 0).toLocaleString()}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-semibold text-zinc-400 items-end">
                        {/* Headers */}
                        <div className="hidden sm:block text-[10px] uppercase text-zinc-500">Component Name</div>
                        <div className="hidden sm:block text-[10px] uppercase text-zinc-500">Calc Type & Value</div>
                        <div className="hidden sm:block text-[10px] uppercase text-zinc-500 text-right">Calculated Amount</div>

                        {/* Basic Salary */}
                        <div className="text-zinc-200 font-bold self-center">1. Basic Salary</div>
                        <div>
                          {isEditingSalary ? (
                            <div className="flex space-x-1.5 items-center">
                              <select
                                ...
                                className="bg-zinc-950 border border-zinc-800 text-white rounded px-1.5 py-0.5 text-xs focus:outline-none"
                              >
                              ...
                              <input
                                ...
                                className="bg-zinc-950 border border-zinc-800 text-white rounded px-1.5 py-0.5 text-xs w-20 text-right focus:outline-none focus:border-purple-600"
                              />
                            </div>
                          ) : (
                        ...
                        <div className="text-right text-zinc-200 font-mono">
                          ₹{calcs?.basicAmt.toLocaleString()}
                        </div>

                        {/* HRA */}
                        <div className="text-zinc-200 font-bold self-center">2. House Rent Allowance (HRA)</div>
                        <div>
                          {isEditingSalary ? (
                            <div className="flex space-x-1.5 items-center">
                              <select
                        ...
                        {/* Standard Allowance */}
                        <div className="text-zinc-200 font-medium self-center text-zinc-300 font-semibold">3. Standard Allowance</div>
                        <div>
                          {isEditingSalary ? (
                            <div className="flex space-x-1.5 items-center">
                              <select
                        ...
                        {/* Performance Bonus */}
                        <div className="text-zinc-200 font-medium self-center text-zinc-300 font-semibold">4. Performance Bonus</div>
                        <div>
                          {isEditingSalary ? (
                            <div className="flex space-x-1.5 items-center">
                              <select
                        ...
                        <div className="text-zinc-200 font-medium self-center text-zinc-300 font-semibold">5. Leave Travel Allowance</div>
                        <div>
                          {isEditingSalary ? (
                            <div className="flex space-x-1.5 items-center">
                              <select
                        ...
                        {/* Fixed Allowance */}
                        <div className="text-zinc-200 font-medium self-center text-zinc-300 font-semibold">6. Fixed Allowance</div>
                        <div>
                          {isEditingSalary ? (
                            <div className="flex space-x-1.5 items-center">
                              <select
                ...
                <div className="space-y-6">
                  ...
                  {/* PF Contributions */}
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                    <h4 className="text-xs font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-2.5">Provident Fund (PF)</h4>

                    <div className="space-y-3.5 text-xs">
                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Employee PF Contribution (%)</span>
                        {isEditingSalary ? (
                          <input
                            type="number"
                          ...
                          <span className="text-zinc-200 mt-1 block font-medium">{salaryInfo?.pf_employee_rate}%</span>
                        )}
                        {calcs && (
                          <span className="text-[10px] text-zinc-400 mt-1 block">
                            Computed: <strong className="text-zinc-300 font-mono">₹{calcs.employeePf.toLocaleString()} / month</strong>
                          </span>
                        )}
                      </div>

                      <div>
                        <span className="text-[10px] uppercase font-semibold text-zinc-500 block">Employer PF Contribution (%)</span>
                        {isEditingSalary ? (
                          <input
                            type="number"
                          ...
                          <span className="text-zinc-200 mt-1 block font-medium">{salaryInfo?.pf_employer_rate}%</span>
                        )}
                        {calcs && (
                          <span className="text-[10px] text-zinc-400 mt-1 block">
                            Computed: <strong className="text-zinc-300 font-mono">₹{calcs.employerPf.toLocaleString()} / month</strong>
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  {/* Professional Tax */}
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
                    <h4 className="text-xs font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-2.5">Professional Tax</h4>

                    <div className="text-xs">
                      <span className="text-[10px] uppercase font-semibold text-zinc-500 block font-semibold">Monthly Professional Tax</span>
                      {isEditingSalary ? (
                        <input
                          type="number"
                        ...
                        <span className="text-zinc-200 mt-1 block font-semibold text-rose-400 font-mono">
                  ...
                  <div className="rounded-xl border border-purple-500/20 bg-purple-950/5 p-6 space-y-3.5 shadow-md">
                    <h4 className="text-xs font-bold text-white uppercase tracking-wider border-b border-purple-500/10 pb-2">Wage Summary</h4>
                    
                    <div className="space-y-2 text-xs">
                      <div className="flex justify-between">
                        <span className="text-zinc-400">Total Monthly Wage:</span>
                        <span className="font-bold text-white">₹{Number(isEditingSalary ? editSalaryForm.monthly_wage || 0 : salaryInfo?.monthly_wage || 0).toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-zinc-400">Calculated Components:</span>
                        <span className="font-bold text-indigo-400">₹{calcs?.totalCalculated.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between border-t border-purple-500/10 pt-2 font-bold text-purple-400">
        ...
        {activeTab === "security" && isOwner && (
          <div className="max-w-md mx-auto rounded-xl border border-zinc-800 bg-zinc-900/30 p-6 space-y-4">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider border-b border-zinc-850 pb-3">Update Security Password</h3>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3.5 py-2 text-sm text-white placeholder-zinc-750 focus:border-purple-500 focus:outline-none transition"
                  />
                  <button
                    type="button"
                    onClick={() => setShowNewPasswordToggle(!showNewPasswordToggle)}
                    className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-zinc-500 hover:text-zinc-300 font-semibold cursor-pointer"
                  >
